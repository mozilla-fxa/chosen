...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.set_default_values = function() {
      ...
      return this.unique_id = "chosen-id-" + (Math.random().toString(36).substring(2, 6));
    };
  ...
  this.Chosen = (function(superClass) {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      this.search_results.writeAttribute('id', this.unique_id + "-" + "listbox");
      this.search_results.writeAttribute('attr-labelledby', this.unique_id);
      this.search_field.writeAttribute({
        'id': this.unique_id,
        'role': 'combobox',
        'aria-haspopup': 'true',
        'aria-owns': this.search_results.readAttribute('id'),
        'aria-expanded': 'false'
      });
      this.search_field_scale();
    ...
    Chosen.prototype.result_do_highlight = function(el) {
      ...
      this.search_field.writeAttribute('aria-activedescendant', el.readAttribute('id'));
